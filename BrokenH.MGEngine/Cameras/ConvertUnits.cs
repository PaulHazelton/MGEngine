	...
	public static class ConvertUnits
	{
		...
		public static Rectangle ToDisplayUnits(Rectangle simUnits)
		{
			return new Rectangle(
				(int)(simUnits.X * _displayUnitsToSimUnitsRatio),
				(int)(simUnits.Y * _displayUnitsToSimUnitsRatio),
				(int)(simUnits.Width * _displayUnitsToSimUnitsRatio),
				(int)(simUnits.Height * _displayUnitsToSimUnitsRatio)
			);
		}
